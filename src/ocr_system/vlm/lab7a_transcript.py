...
[4] รูปแบบข้อมูล
    ...
    - credit  : จำนวนเต็ม เช่น 3  (ไม่ใช่ "3(3-0-6)")
        1. สกัดค่าในคอลัมน์ Credit (หน่วยกิต) ให้เป็น "ตัวเลขจำนวนเต็ม" เท่านั้น (เช่น 1, 2, 3, 4)
        - หากในเอกสารพิมพ์ว่า "3(3-0-6)" หรือ "3(2-3-4)" ให้ดึงมาเฉพาะตัวเลขรวมข้างหน้า คือ "3"
        - ห้ามใส่โครงสร้างวงเล็บตัวชั่วโมง เช่น "(3-0-6)" มาในช่อง Credit เด็ดขาด
        2. หากช่อง Credit ในภาพมองเห็นไม่ชัด หรือถูกจัดหน้าเหลื่อมไปทางช่องชื่อวิชา:
        - ให้สังเกตตัวเลขหน่วยกิตที่มักจะอยู่ระหว่างชื่อวิชากับเกรด แล้วนำมาใส่ในช่อง <td> ของ Credit ให้ถูกต้อง
        - ห้ามเว้นช่อง Credit เป็น <td></td> ว่างเปล่า หากมีตัวเลขปรากฏอยู่บริเวณนั้น
    ...
    - by_signature : สกัดชื่อ-นามสกุลของผู้ลงนามท้ายเอกสารใส่ในฟิลด์ by_signature
        - ให้ลบเครื่องหมายวงเล็บเปิด "(" และวงเล็บปิด ")" ออกทั้งหมด ให้เหลือเฉพาะชื่อและตำแหน่งที่อยู่ข้างในเท่านั้น
        ตัวอย่าง: 
        - "(นายสมชาย ใจดี)" -> "นายสมชาย ใจดี"
        - "(ผู้ช่วยศาสตราจารย์ ดร.ทดสอบ นามสกุล)" -> "ผู้ช่วยศาสตราจารย์ ดร.ทดสอบ นามสกุล"
